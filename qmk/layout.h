...
#define _FUN_LAYOUT \
/*   ,-------------------------------------------------.    ,-------------------------------------------------.   */\
/*   | GAME    | F4      | F5      | F6      | F8      |    | F12     | WH DOWN | MS UP   | WH UP   | VOL UP  |   */\
...
/*   | ` ~     | 1 !     | 2 @     | 3 #     | ] }     |    |         |         | UP      |         | TO HOME |   */\
       KC_GRV  , KC_1    , KC_2    , KC_3    , KC_4    ,      KC_NO   , KC_NO   , KC_UP   , KC_NO   , TO_HOME ,     \
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
/*   | CTRL    | Q       | W       | E       | R       |    |         | LEFT    | DOWN    | RIGHT   |         |   */\
       KC_LCTL , KC_Q    , KC_W    , KC_E    , KC_R    ,      KC_NO   , KC_LEFT , KC_DOWN , KC_RGHT , KC_NO   ,     \
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
/*   | SHIFT   | A       | S       | D       | F       |    |         |         | , <     | . >     | / ?     |   */\
       KC_LSFT , KC_A    , KC_S    , KC_D    , KC_F    ,      KC_NO   , KC_NO   , KC_COMM , KC_DOT  , KC_SLSH ,     \
/*   `-------------------------------------------------|    |-------------------------------------------------'   */\
/*                                 | SPACE   |         |    | ENTER   |         |                                 */\
                                     KC_SPC  , KC_NO   ,      KC_ENT  , KC_NO
/*                                 `-------------------'    `-------------------'                                 */
